...
angular.module('json-schema-builder-example', [
  'ui.bootstrap', 
  'json-schema-builder'
])
.config([
	'jsonSchemaBuilderDefaultOptionsProvider',
	function(jsonSchemaBuilderDefaultOptionsProvider){
    jsonSchemaBuilderDefaultOptionsProvider.setDefaultOptions({language: 'en'});
  }
]);
